  ...
  <script>
	...
	$().ready(function() {
      ...
      <article class="container">
        ...
        <form class="form-horizontal cmxform" id="commentForm2" method="POST" action="">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label" for="inputPassword">비밀번호확인</label>
        <div class="col-sm-6">
          <input class="form-control" id="inputPassword" type="password" placeholder="비밀번호" name="CPW">
        <p class="help-block">숫자, 특수문자 포함 8자 이상</p>
        </div>
        </div>
          <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-12 text-center">
            <button class="btn btn-primary"  input class ="submit" type="submit">회원가입<i class="fa fa-check spaceLeft"></i></button>
