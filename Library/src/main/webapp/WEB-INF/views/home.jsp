...
<div class="container">
  ...
  <div class="btn-group btn-group-justified">
    <a href="#" class="btn btn-primary">도서관정보</a>
    <a href="#" class="btn btn-primary">자유게시판</a>
    <a href="#" class="btn btn-primary">추천도서</a>
    <a href="#" class="btn btn-primary">관리자소개</a>
...
<fieldset> <legend>Sign-In</legend> <label for="inputtext1">Client ID:</label> <input id="inputtext1" name="inputtext1" value="" type="text" /> <label for="inputtext2">Password:</label>
<input id="inputtext2" name="inputtext2" value="" type="password" />
<input id="inputsubmit1" name="inputsubmit1" value="회원가입" type="submit" />
<input id="inputsubmit1" name="inputsubmit2" value="로그인 " type="submit" />
